...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="button">
                                                <a href="tambahTugas.php" class="btn btn-primary">
                                                    <li class="fa fa-plus"></li>
                                                    Tambah Tugas
                                                </a>
                                                <a href="cetakTugas.php" class="btn btn-info ml-2">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <form class="search" method="get">
                                                <div class="input-group">
                                                    <input class="form-control" name="search_tugas" type="text" placeholder="Cari Tugas" value="<?= htmlspecialchars($searchTugas); ?>">
                                                ...
                                                <?php foreach ($dataTugas as $t): ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($t['status'] === 'belum') {
                                                                $badgeClass = 'bg-secondary'; // Jika status masih "belum", berikan badge merah
                                                            } elseif ($t['status'] === 'proses') {
                                                                $badgeClass = 'bg-info'; // Jika status "proses", berikan badge kuning
                                                            } elseif ($t['status'] === 'selesai') {
                                                                $badgeClass = 'bg-success'; // Jika status "selesai", berikan badge hijau
                                                            }
                                                            ?>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="editTugas.php?id=<?= htmlspecialchars($t['id']) ?>" class="btn btn-sm btn-warning mr-2"><i class="fas fa-edit"></i></a>
                                                                <form class="hapusTugas" action="hapusTugas.php" method="post">
                                                                    <input type="hidden" name="id" id="id" value="<?= htmlspecialchars($t['id']) ?>">
    ...
    <script>
        $(".hapusTugas").on("submit", function(e) {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: 'Error!',
                                text: 'Gagal menghapus tugas: ' + xhr.responseText,
                                icon: 'error',
                                confirmButtonText: 'Tutup'
                            });
                        }
