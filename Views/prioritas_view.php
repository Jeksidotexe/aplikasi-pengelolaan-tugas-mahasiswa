...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="button">
                                                <a href="tambahPrioritas.php" class="btn btn-primary">
                                                    <li class="fa fa-plus"></li> Tambah Prioritas
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <form class="search" method="get">
                                                <div class="input-group">
                                                    <input class="form-control" name="search_prioritas" type="text" placeholder="Cari Prioritas" value="<?= htmlspecialchars($searchPrioritas); ?>">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <?php if ($dataPrioritas): ?>
                                                <?php $no = 1; ?>
                                                <?php foreach ($dataPrioritas as $p): ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($p['level_prioritas'] === 'rendah') {
                                                                $badgeClass = 'bg-success'; // Jika level prioritas "rendah", berikan badge hijau
                                                            } elseif ($p['level_prioritas'] === 'sedang') {
                                                                $badgeClass = 'bg-warning'; // Jika level prioritas "sedang", berikan badge kuning
                                                            } elseif ($p['level_prioritas'] === 'tinggi') {
                                                                $badgeClass = 'bg-danger'; // Jika level prioritas "tinggi", berikan badge merah
                                                            }
                                                            ?>
                                                            <span class="badge <?= $badgeClass; ?>"><?= htmlspecialchars($p['level_prioritas']); ?></span>
                                                        </td>
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="editPrioritas.php?id=<?= htmlspecialchars($p['id']) ?>" class="btn btn-sm btn-warning mr-2"><i class="fas fa-edit"></i></a>
                                                                <form class="hapusPrioritas" action="hapusPrioritas.php" method="post">
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="6">Tidak ada data prioritas.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        $(".hapusPrioritas").on("submit", function(e) {
            e.preventDefault(); // Mencegah form dari pengiriman default

            // Konfirmasi penghapusan kepada pengguna
            Swal.fire({
                title: "Yakin ingin menghapus prioritas ini?",
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: 'Error!',
                                text: 'Gagal menghapus prioritas: ' + xhr.responseText,
                                icon: 'error',
                                confirmButtonText: 'Tutup'
                            });
                        }
