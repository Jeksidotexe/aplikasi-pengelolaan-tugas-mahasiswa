...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tambah Prioritas</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="dashboard.php">Home</a></li>
                                <li class="breadcrumb-item active">Tambah Prioritas</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form id="tambahPrioritasForm" action="tambahPrioritas.php" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_tugas" id="id_tugas">
                                                ...
                                                <?php if ($dataTugas) : ?>
                                                    <?php foreach ($dataTugas as $kat) : ?>
                                                        <option value="<?= htmlspecialchars($kat['id']) ?>"><?= htmlspecialchars($kat['judul']) ?></option>
                                                    <?php endforeach; ?>
                                                <?php else : ?>
    ...
    <script>
        $("#tambahPrioritasForm").on("submit", function(e) {
            e.preventDefault(); // Mencegah form dari pengiriman default

            $.ajax({
                type: "POST",
                url: "tambahPrioritas.php",
                data: $(this).serialize(),
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: 'Error!',
                        text: 'Gagal menambahkan prioritas: ' + xhr.responseText,
                        icon: 'error',
                        confirmButtonText: 'Tutup'
                    });
                }
