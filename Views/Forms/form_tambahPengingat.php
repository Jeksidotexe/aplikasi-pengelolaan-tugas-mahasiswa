...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tambah Pengingat</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form id="tambahPengingatForm" action="tambahPengingat.php" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="id_tugas" id="id_tugas">
                                                ...
                                                <?php if ($dataTugas) : ?>
                                                    <?php foreach ($dataTugas as $p) : ?>
                                                        <option value="<?= htmlspecialchars($p['id']) ?>"><?= htmlspecialchars($p['judul']) ?></option>
                                                    <?php endforeach; ?>
                                                <?php else : ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                                <input type="text" name="waktu" id="waktu" class="form-control datetimepicker-input" data-target="#reservationdatetime">
    ...
    <script>
        $("#tambahPengingatForm").on("submit", function(e) {
            e.preventDefault(); // Mencegah form dari pengiriman default

            $.ajax({
                type: "POST",
                url: "tambahPengingat.php",
                data: $(this).serialize(),
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: 'Error!',
                        text: 'Gagal menambahkan pengingat: ' + xhr.responseText,
                        icon: 'error',
                        confirmButtonText: 'Tutup'
                    });
                }
