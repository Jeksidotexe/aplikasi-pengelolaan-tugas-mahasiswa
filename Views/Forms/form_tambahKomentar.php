...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tambah Komentar</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form id="tambahKomentarForm" action="tambahKomentar.php" method="post">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label>Judul Tugas</label>
                                            <select class="form-control" name="id_tugas" id="id_kategori">
                                                <option value="">-- Pilih Tugas --</option>
                                                <?php if ($dataTugas) : ?>
                                                    <?php foreach ($dataTugas as $t) : ?>
                                                        <option value="<?= htmlspecialchars($t['id']) ?>"><?= htmlspecialchars($t['judul']) ?></option>
                                                    <?php endforeach; ?>
                                                <?php else : ?>
                                        ...
                                        <div class="form-group">
                                            <label>Isi</label>
                                            <textarea class="form-control" name="isi" id="isi" rows="3" placeholder="Isi ..."></textarea>
                                        </div>
                                    </div>
                                    <!-- /.card-body -->
    ...
    <script>
        $("#tambahKomentarForm").on("submit", function(e) {
            e.preventDefault(); // Mencegah form dari pengiriman default

            $.ajax({
                type: "POST",
                url: "tambahKomentar.php",
                data: $(this).serialize(),
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: 'Error!',
                        text: 'Gagal menambahkan komentar: ' + xhr.responseText,
                        icon: 'error',
                        confirmButtonText: 'Tutup'
                    });
                }
