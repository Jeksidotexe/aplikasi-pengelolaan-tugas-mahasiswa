...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <form id="tambahTugasForm" action="tambahTugas.php" method="post">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                                <input type="text" name="deadline" id="deadline" class="form-control datetimepicker-input" data-target="#reservationdatetime">
    ...
    <script>
        $("#tambahTugasForm").on("submit", function(e) {
            ...
            $.ajax({
                ...
                error: function(xhr, status, error) {
                    Swal.fire({
                        title: 'Error!',
                        text: 'Gagal menambahkan kategori: ' + xhr.responseText,
                        icon: 'error',
                        confirmButtonText: 'Tutup'
                    });
                }
