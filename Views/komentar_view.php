...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="button">
                                                <a href="tambahKomentar.php" class="btn btn-primary">
                                                    <li class="fa fa-plus"></li> Tambah Komentar
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <form class="search" method="get">
                                                <div class="input-group">
                                                    <input class="form-control" name="search_komentar" type="text" placeholder="Cari Komentar" value="<?= htmlspecialchars($searchKomentar); ?>">
                                ...
                                <div class="card-body">
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="editKomentar.php?id=<?= htmlspecialchars($k['id']) ?>" class="btn btn-sm btn-warning mr-2"><i class="fas fa-edit"></i></a>
                                                                <form class="hapusKomentar" action="hapusKomentar.php" method="post">
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td colspan="6">Tidak ada data komentar.</td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
    ...
    <script>
        $(".hapusKomentar").on("submit", function(e) {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: 'Error!',
                                text: 'Gagal menghapus komentar: ' + xhr.responseText,
                                icon: 'error',
                                confirmButtonText: 'Tutup'
                            });
                        }
