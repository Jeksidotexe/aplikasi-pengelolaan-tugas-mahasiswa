...
<body class="hold-transition light-mode sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed">
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="button">
                                                <a href="tambahKategori.php" class="btn btn-primary">
                                                    <li class="fa fa-plus"></li> Tambah Kategori
                                                </a>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <form class="search" method="get">
                                                <div class="input-group">
                                                    <input class="form-control" name="search_kategori" type="text" placeholder="Cari Kategori" value="<?= htmlspecialchars($searchKategori); ?>">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="btn-group btn-group-sm">
                                                                <a href="editKategori.php?id=<?= htmlspecialchars($k['id']) ?>" class="btn btn-sm btn-warning mr-2"><i class="fas fa-edit"></i></a>
                                                                <?php if (isset($error)): ?>
                                                                    <p class="error"><?php echo htmlspecialchars($error); ?></p>
                                                                <?php endif; ?>
                                                                <form class="hapusKategori" action="hapusKategori.php" method="post">
                                                                    <input type="hidden" name="id" id="id" value="<?= htmlspecialchars($k['id']) ?>">
                                                                    <button class="btn btn-sm btn-danger" type="submit" id="submitBtn"><i class="fas fa-trash"></i></button>
                                                                </form>
                                                            </div>
    ...
    <script>
        $(".hapusKategori").on("submit", function(e) {
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr) {
                            Swal.fire({
                                title: 'Error!',
                                text: 'Gagal menghapus kategori: ' + xhr.responseText,
                                icon: 'error',
                                confirmButtonText: 'Tutup'
                            });
                        }
